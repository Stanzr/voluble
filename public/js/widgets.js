...
__twttrlr( function (using, provide, loadrunner, define) {
    ...
    provide( "util/util", function (a) {
        ...
        function d (a) {
            for (var b in a) {
                a.hasOwnProperty( b ) && !a[b] && a[b] !== !1 && a[b] !== 0 && delete a[b]
            }
        }
        ...
        a( {aug : b, array : c, indexOf : e, filter : f, compact : d} )
    } );
    ...
    provide( "xd/jsonrpc", function (a) {
        using( "util/util", "util/events", function (b, c) {
            ...
            b.aug( d.prototype, {expose : function (a) {
                ...
                var b = this.con;
                return[function c (c) {
                    b.send( JSON.stringify( {id : a, result : c} ) )
                }, function d (d) {
                    b.send( JSON.stringify( {id : a, error : d} ) )
                }]
            }} ), e.id = 0, b.aug( e.prototype, c.Emitter, {send : function (a, b, c) {
                return a.send( JSON.stringify( {id : this.id, method : b, params : c} ) ), this
            }, success : function (a) {
    ...
    provide( "xd/detection", function (a) {
        ...
        a( {getFlashEnabled : b, hasPostMessage : !!window.postMessage, isIE : !!navigator.userAgent.match( "MSIE" )} )
    } );
    provide( "xd/base", function (a) {
        using( "util/util", "util/events", function (b, c) {
            ...
            b.aug( d.prototype, c.Emitter, {transportMethod : "", init : function () {
            }, send : function (a) {
                var b;
    ...
    provide( "xd/parent", function (a) {
        using( "xd/base", "util/util", "xd/detection", function (b, c, d) {
            ...
            i.prototype = new b.Connection, c.aug( i.prototype, {_createChild : function () {
                this.options.window ? this._createWindow() : this._createIframe()
            }, _createIframe : function () {
                var a = {allowTransparency : !0, frameBorder : "0", scrolling : "no", tabIndex : "0", name : this._name()}, b, e, f, h = c.aug( c.aug( {}, a ), this.options.iframe );
                ...
                var a = {width : 550, height : 450, personalbar : "0", toolbar : "0", scrollbars : "1", resizable : "1"}, b, d, e, f = c.aug( c.aug( {}, a ), this.options.window ), g = screen.width, i = screen.height;
            ...
            j.prototype = new i, c.aug( j.prototype, {init : function () {
                function b (b) {
            ...
            k.prototype = new i, c.aug( k.prototype, {_setup : function () {
                var a = this;
                using( "xd/flash", function (b) {
                    window["__xdcb" + a.token] = {receive : function (b) {
            ...
            l.prototype = new i, c.aug( l.prototype, {init : function () {
            }, _performSend : function (a) {
    ...
    provide( "i18n/languages", function (a) {
        a( ["it", "no", "de", "fr", "ja", "zh-cn", "hi", "hu", "sv", "fi", "es", "ru", "ko", "pt", "zh-tw", "id", "cs", "msa", "pl", "es-es", "pt-pt", "da", "he", "el", "tr", "nl", "fil"] )
    } );
        ...
        a( function (a) {
            ...
            if (a.attributes) {
                for (var e in a.attributes) {
                    c.setAttribute( e, a.attributes[e] );
                }
            }
    ...
    provide( "util/nodeselect", function (a) {
        var b = document, c = "querySelectorAll"in b ? function (a, c) {
            ...
            for (i = 0; e = d[i]; i++) {
                e.tagName.toLowerCase() == a && f.push( e );
            }
            return f
        } : function (a, c) {
            var d = b.getElementsByTagName( a ), e, f = new RegExp( "(?:^|\\s+)" + c + "(?:\\s+|$)" ), g = [];
            for (i = 0; e = d[i]; i++) {
                f.test( e.className ) && g.push( e );
            }
            return g
        };
        a( c )
    ...
    provide( "tfw/widget/base", function (a) {
        using( "util/util", "util/domready", "util/nodeselect", "util/querystring", "util/iframe", "i18n/languages", function (b, c, d, e, f, g) {
            ...
            function p () {
                ...
                for (var e in a) {
                    ...
                    for (var f = 0, g; g = b[f]; f++) {
                        if (g.getAttribute( "data-rendering" )) {
                            continue;
                        }
            ...
            var h = 0, i, j, k = {list : [], byId : {}}, l = 2, m = function () {
            };
            b.aug( m.prototype, {setLanguage : function (a) {
                ...
                if (this.langs) {
                    var c = this.lang;
                    if (!c || !this.langs.hasOwnProperty( c )) {
                        c = "en";
                    }
                    a = this.langs[c][a] || a
                }
                return a.replace( /\{\{([a-z_]+)\}\}/g, function (a, c) {
                    return b[c] || "{{" + c + "}}"
                } )
            }, add : function (a) {
                ...
                return l
            }} ), a( {Base : m, init : q, embed : r, find : s, TWITTER_PROFILE_URL : /^https?\:\/\/(?:www\.)?twitter\.com\/(?:#!?\/)?([\w_]{1,20})\/?$/} )
        } )
    } );
        ...
        using( "util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            function n (a, b) {
                using( "xd/parent", "xd/jsonrpc", function (c, d) {
                    var e = c.connect( {window : {width : 550, height : 450}, src : a} );
                    d( e ).expose( {trigger : function (a, c) {
                        twttr.events.trigger( a, {target : b, region : "intent", type : a, data : c} )
                    }} )
                } )
            }
        ...
        using( "util/params", function (b) {
            function i () {
                ...
                for (; a < b; a++) {
                    try {
                        e = parent.frames[a];
                        if (e && typeof e.openIntent == "function") {
                            return d = e
                        }
                    }
                    catch (f) {
            ...
            function k (a, b, c) {
                l( function (d) {
                    d.trigger( "_resize", {width : b, height : c}, a )
                } )
            }
            ...
            function l () {
                ...
                }, c = a.timeout || function () {
                }, d = a.nohub || function () {
                }, f = a.attempt !== undefined ? a.attempt : h;
                if (!j() || e) {
                    return d(), !1;
                }
                var k = i();
                ...
                window.setTimeout( function () {
                    l( {success : b, timeout : c, nohub : d, attempt : f} )
                }, g )
            }

            var c = "twttrHubFrame", d, e, f, g = 100, h = 20;
            a( {resize : k, withHub : l, isDynamicWidget : j} )
        } )
    } );
    ...
    provide( "tfw/widget/guest_cookie", function (a) {
        using( "dom/cookie", "util/donottrack", function (b, c) {
            function f () {
                if (c()) {
                    b( d ) && b( d, null, {domain : ".twitter.com", path : "/"} );
                } else if (!b( d )) {
                    var a = "v1:", f = (+(new Date)).toString() + Math.round( Math.random() * 999999999 );
                    b( d, a + f, {domain : ".twitter.com", path : "/", expires : e} )
                }
            }

            var d = "pid", e = 1051897;
            a( {set : f, guest_id_cookie : d, default_expire : e} )
        } )
    } );
    provide( "tfw/widget/tracking", function (a) {
        using( "dom/cookie", "util/donottrack", "tfw/widget/guest_cookie", "util/widgetrpc", function (b, c, d, e) {
            ...
            var f = "twttr_", g = "//platform.twitter.com/widgets/images/", h = {tweetbutton : "t.gif", followbutton : "f.gif", tweetembed : "e.gif"};
     ...
     */
        !function (a, b) {
            ...
            function N (a, b, c, e, f, g, h) {
                var j, k, l;
                if (b && this.tagName.toLowerCase() !== b) {
                    return!1;
                }
                if (c && (j = c.match( v )) && j[1] !== this.id) {
                    return!1;
                }
                if (c && (q = c.match( w ))) {
                    for (d = q.length; d--;) {
                        k = q[d].slice( 1 );
                        if (!(I.g( k ) || I.s( k, new RegExp( "(^|\\s+)" + k + "(\\s+|$)" ) )).test( this.className )) {
                            return!1
                        }
                    }
                }
                if (e && !h) {
                    i = this.attributes;
                    for (l in i) {
                        if (Object.prototype.hasOwnProperty.call( i, l ) && (i[l].name || l) == f) {
                            return this
                        }
                    }
                }
            ...
            function R (a) {
                ...
                for (e = 0, g = b.length, f = 0; e < g; e++) {
                    n = b[e], j = n;
                    for (d = h.length; d--;) {
                        i:while (j !== B && (j = j.parentNode)) {
                            if (p = N.apply( j, M( h[d] ) )) {
                                break i;
                            }
                        }
                    }
            ...
            var I = new H, J = new H, K = new H, L = new H, S = "compareDocumentPosition"in B ? function (a, b) {
                ...
                return b.querySelector && b.querySelectorAll ? V : function (a, c) {
                    ...
                    if (h = a.match( A )) {
                        ...
                        for (f = 0, g = s.length, e = 0; f < g; f++) {
                            k.test( s[f].className ) && (i[e++] = s[f]);
                        }
                        return i
                    }
                    for (f = 0, s = a.split( "," ), g = s.length; f < g; f++) {
                        j[f] = R( s[f] );
                    }
                    for (f = 0, g = j.length; f < g && (u = j[f]); f++) {
                        ...
                        if (d !== b) {
                            m = [];
                            for (e = 0, h = u.length; e < h && (l = u[e]); e++) {
                                S( l, d ) && m.push( l )
                            }
                        }
                        i = i.concat( m )
    ...
    provide( "util/tweetparser", function (a) {
        using( "util/qweryutil", function (b) {
            function d (a) {
                return a && c.test( a ) ? a.match( c )[1] : !1
            }

            function e (a) {
                if (!a || !a.nodeName || a.nodeName.toLowerCase() != "blockquote") {
                    return!1;
                }
                var c = {}, d = /twitter\.com\/(?:#!\/)?[a-zA-Z0-9_]{1,20}\/status(?:es)?\/(\d*)\/?/, e = b.qwery( "p", a );
                if (e.length) {
                    var g = e[0];
                    c.text = g.textContent || g.innerText || "", c.rendered_text = g.innerHTML || ""
                }
                var h = b.qwery( "a", a ), i = h.length && h[h.length - 1];
                return i && (i.getAttribute( "data-datetime" ) ? c.created_at = i.getAttribute( "data-datetime" ) : c.time = i.textContent || i.innerText), c.user = f( a ), c.id_str = i && i.href && d.test( i.href ) ? RegExp.$1 : "", c.id_str && c.text && c.user ? c : !1
            }

            function f (a) {
                var c = {}, d = /^\s*(.+)\s+\(@([a-zA-Z0-9_]{1,20})\)\s*/, e = /twitter\.com\/(#!\/)?([a-zA-Z0-9_]{1,20})/;
                for (var f = 0; f < a.childNodes.length; f++) {
                    var g = a.childNodes[f];
                    if (g.nodeType === 3 && d.test( g.nodeValue ) || g.nodeType === 1 && g.nodeName.toLowerCase() === "p" && d.test( g.innerText )) {
                ...
                var h = b.qwery( "a", a ), i = h.length && h[h.length - 1];
                return e.test( i.href ) ? (c.name = "", c.screen_name = RegExp.$2, c) : !1
            }

            var c = /\/([0-9]+)\/?$/;
            a( {parseTweet : e, parseId : d, parseAuthor : f} )
        } )
    } );
    ...
    provide( "tfw/widget/tweet", function (a) {
        using( "util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            h.prototype = new c.Base, b.aug( h.prototype, {supportCount : {vertical : 1, horizontal : 1, none : 1}, titles : {en : "Twitter Tweet Button"}, langDimensions : {en : {vertical : 55, horizontal : 110, none : 55}, de : {vertical : 67, horizontal : 122, none : 67}, es : {vertical : 64, horizontal : 118, none : 64}, fr : {vertical : 65, horizontal : 118, none : 65}, id : {vertical : 55, horizontal : 110, none : 55}, it : {vertical : 55, horizontal : 110, none : 55}, ko : {vertical : 55, horizontal : 110, none : 55}, ja : {vertical : 80, horizontal : 130, none : 80}, nl : {vertical : 55, horizontal : 110, none : 55}, pt : {vertical : 66, horizontal : 120, none : 66}, ru : {vertical : 68, horizontal : 120, none : 68}, tr : {vertical : 66, horizontal : 120, none : 66}}, dimensions : {x : {m : {normal : 85, horizontal : 130}, l : {normal : 104, horizontal : 162}}, y : {m : {normal : 20, vertical : 62}, l : {normal : 28, vertical : 28}}}, parameters : function () {
                var a = {text : this.text, url : this.url, via : this.via, related : this.related, count : this.count, lang : this.lang, counturl : this.counturl, searchlink : this.searchlink, placeid : this.placeid, original_referer : location.href, id : this.id, size : this.size, type : this.type, screen_name : this.screen_name, button_hashtag : this.button_hashtag, hashtags : this.hashtags, align : this.align, dnt : this.dnt, enableNewSizing : !!this.enableNewSizing, _ : +(new Date), _version : this.version};
                return b.compact( a ), d.encode( a )
            }, render : function (a) {
                var b = a.assetUrl() + "/widgets/tweet_button.1324331373.html#" + this.parameters(), c = this.enableNewSizing ? this.dimensions.x[this.size]["horizontal" == this.count ? "horizontal" : "normal"] : this.langDimensions[this.lang][this.count], d = this.dimensions.y[this.size]["vertical" == this.count ? "vertical" : "normal"], e = this.titles.en, f = this;
                this.originElement.className += this.count ? " twitter-count-" + this.count : "", this.element = this.create( b, this.originElement.className, [this.enableNewSizing ? 1 : c, d], {title : e} ), window.setTimeout( function () {
    ...
    provide( "tfw/widget/tweetembed", function (a) {
        using( "util/util", "tfw/widget/base", "tfw/widget/tweet", "util/uri", "util/insert", "tfw/data", "i18n/i18n", "util/params", "util/qweryutil", "util/tweetparser", "tfw/widget/tracking", function (b, c, d, e, f, g, h, i, j, k, l) {
            var m = "1.0", n = i.fromQuery( document.location ), o = function (a) {
                this.init(), this.originElement = a, this.id = this.generateId();
                var c = /^([0-9]+)( ?px)?$/, d = this.params();
                this.setLanguage(), this.related = d.related || a.getAttribute( "data-related" ), this.partner = d.partner || a.getAttribute( "data-partner" ), this.classNames = b.filter( a.className.split( " " ), function (a) {
                    return!/(twitter-tweet)/.test( a )
                } ), this.classNames.push( ["twp-container"] ), this.styleAttr = [], this.styleAttr.push( a.getAttribute( "style" ) || "" );
                var e, f = a.getAttribute( "width" ) || "";
                (e = f.match( c )) ? this.width = e[1] : a.className.match( /(\b|^)tw-align-(left|right)(\b|$)/i ) && (this.width = "350"), this.width && this.styleAttr.push( "width:" + this.width + "px!important" ), this.hideThread = ~b.indexOf( this.classNames, "tw-hide-thread" ), this.hideMedia = ~b.indexOf( this.classNames, "tw-hide-media" ), this.data = k.parseTweet( this.originElement ), this.inReplyTo = a.getAttribute( "data-in-reply-to" ) || ""
            };
            o.prototype = new c.Base, b.aug( o.prototype, {init : function () {
                function a (a) {
                ...
                a( "widgets.css" ), a( "twt/twt.css" ), o.prototype.init = function () {
                    return!0
                }
            }, create : function (a, b) {
                var c = this, d = null, e = !!a.twt_data_stub;
                if (!e) {
                    var g = {};
                    g.status_id = a.id_str, l.addVar( g, "variant", m ), l.addVar( g, "referrer", document.location.toString() ), l.addPixel( document.body, g, "tweetembed", !0 ), c.data.in_reply_to_data && (g.status_id = c.data.in_reply_to_data.id_str, l.addPixel( document.body, g, "tweetembed", !0 ))
                }
                return using( "lib/twt", function (g) {
                    g( c.lang, function (g) {
                        g.ender( function (h) {
                            var i = document.createElement( "div" ), j = g.autoFormat( c.width || c.element ), k = g( a, {format : j, popupWebIntents : !1, tweetElement : "blockquote", showMedia : !c.hideMedia, showErrors : !1, showFollowButton : !e, renderActions : !e, partner : c.partner, related : c.related} ), l = '<div id="{{id}}" class="{{classNames}}" lang="{{lang}}" {{#style}}style="{{style}}"{{/style}}>{{{twt}}}</div>', m = {id : c.id, classNames : b, style : c.styleAttr.join( ";" ), lang : c.lang, twt : c.data.in_reply_to_data ? k.inReplyTo( a.in_reply_to_data ).html() : k.html()};
                            i.innerHTML = h.to_html( l, m ), d = f( i.firstChild, c.element )
                        } )
                    } )
                } ), d
            }, render : function (a) {
                ...
                using( "lib/twt", function (a) {
                    a( b.lang, function () {
                        var a = b.classNames.join( " " );
                        b.data.twt_data_stub = !0, b.element = b.originElement, b.element = b.create( b.data, a ), b.inReplyTo && !b.hideThread ? g.status( {id : [b.data.id_str, b.inReplyTo], complete : function (c) {
                            var d = c[0], e = c[1];
                            if (d.error) {
                                return;
                            }
                            d.in_reply_to_status_id_str === e.id_str ? (b.data = d, b.data.in_reply_to_data = e, b.element = b.create( b.data, a )) : d.in_reply_to_status_id_str ? g.status( {id : d.in_reply_to_status_id_str, complete : function (c) {
                                b.data = d, b.data.in_reply_to_data = c, b.element = b.create( b.data, a )
                            }} ) : (b.data = d, b.element = b.create( b.data, a ))
                        }} ) : g.status( {id : b.data.id_str, complete : function (c) {
                            c.error ? (b.data.error = c.error, b.element = b.create( b.data, a )) : (b.data = c, c.in_reply_to_status_id_str && !b.hideThread ? g.status( {id : c.in_reply_to_status_id_str, complete : function (d) {
                                b.data = c, b.data.in_reply_to_data = d, b.element = b.create( b.data, a )
                            }} ) : b.element = b.create( b.data, a ))
                        }} )
                    } )
                } )
            }} ), a( {Embeddable : o} )
    ...
    provide( "tfw/widget/follow", function (a) {
        using( "util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            f.prototype = new c.Base, b.aug( f.prototype, {titles : {en : "Twitter Follow Button"}, dimensions : {x : {m : 300, l : 350}, y : {m : 20, l : 28}}, parameters : function () {
                var a = {screen_name : this.screenName, lang : this.lang, show_count : this.showCount, show_screen_name : this.showScreenName, align : this.align, id : this.id, preview : this.preview, size : this.size, dnt : this.dnt, enableNewSizing : !!this.enableNewSizing, _ : +(new Date), _version : this.version};
                return b.compact( a ), d.encode( a )
            }, screenNameFromHref : function () {
                var a = this.originElement.href, b;
                if (b = a.match( c.TWITTER_PROFILE_URL )) {
                    return b[1]
                }
            }, render : function (a) {
                if (!this.screenName) {
                ...
                var b = a.assetUrl() + "/widgets/follow_button.1324331373.html#" + this.parameters(), c = this.width || this.dimensions.x[this.size], d = this.dimensions.y[this.size], e = this.titles.en, f = this;
                this.element = this.create( b, "twitter-follow-button", [this.enableNewSizing ? 1 : c, d], {title : e} ), window.setTimeout( function () {
                    f.element.getAttribute( "data-resized" ) || (f.element.style.width = c + (typeof c != "string" ? "px" : ""))
                }, 15e3 )
            }} ), a( {Embeddable : f} )
        } )
    ...
    (function () {
        ...
        if (twttr.widgets) {
            return twttr.widgets.loaded && twttr.widgets.load(), !1;
        }
        if (twttr.init) {
            return!1;
        }
        ...
        var a = [];
        twttr.events = {bind : function (b, c) {
            return a.push( [b, c] )
            ...
            b( function () {
                using( "util/util", "tfw/widget/follow", "tfw/widget/tweet", "tfw/widget/tweetembed", "tfw/widget/intent", "util/events", "tfw/widget/base", function (b, c, d, e, f, g, h) {
                    ...
                    var i = {};
                    i.widgets = {"a.twitter-share-button" : d.Embeddable, "a.twitter-mention-button" : d.Embeddable, "a.twitter-hashtag-button" : d.Embeddable, "a.twitter-follow-button" : c.Embeddable, "blockquote.twitter-tweet" : e.Embeddable, "div.twitter-tweet" : e.Embeddable, body : f.Listener}, i.assetUrl = function (a) {
                        return j( a ) + "://" + twttr.host
                    }, using( "xd/parent", "xd/jsonrpc", function (a, b) {
                        var c = "twttrHubFrame", d = i.assetUrl() + "/widgets/hub.1324331373.html";
                        if (window.location && window.location.href.match( /LinkedIn\.app/ )) {
                            return!1;
                        }
                        if (document.getElementById( c )) {
                            return;
                        }
                        twttr.events.hub = a.connect( {src : d, iframe : {name : c, style : "position:absolute;top:-9999em;width:10px;height:10px"}} ), b( twttr.events.hub ).expose( {trigger : function (a, b, c) {
                            b = b || {};
                            var d = b.region;
                            delete b.region, twttr.events.trigger( a, {target : h.find( c ), data : b, region : d, type : a} )
                        }} )
                    } );
